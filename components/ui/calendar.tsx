        ...
        <DayPicker
            ...
            classNames={{
                ...
                caption_label: cn(
                    ...
                    captionLayout === 'label'
                        ? 'text-sm'
                        : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]: text-muted dark:text-muted-foreground [&>svg]:size-3.5',
                    defaultClassNames.caption_label
                ),
                table: 'w-full border-collapse',
                weekdays: cn('flex', defaultClassNames.weekdays),
                weekday: cn(
                    'flex-1 rounded-md font-normal text-[0.8rem] text-muted dark:text-muted-foreground select-none',
                ...
                week_number: cn(
                    'text-[0.8rem] text-muted dark:text-muted-foreground select-none',
                ...
                today: cn(
                    'bg-accent rounded-md data-[selected=true]:rounded-lg text-accent-foreground',
                    defaultClassNames.today
                ),
                outside: cn(
                    'text-muted aria-selected:text-muted-foreground dark:text-muted-foreground',
